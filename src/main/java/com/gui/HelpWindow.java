...
public class HelpWindow extends JFrame{    
    public HelpWindow(int port) {
        ...
        JLabel settingsImage = new JLabel(new ImageIcon("src\\main\\java\\com\\gui\\TelchartSettings.png"));
        JLabel testImage = new JLabel(new ImageIcon("src\\main\\java\\com\\gui\\TelchartTest.png"));
